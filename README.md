...
- `scripts/ci.sh` validates the app with `xcodebuildmcp simulator build`.
...
The runner must provide Xcode, `xcodebuildmcp`, and the `asc` CLI for
TestFlight publication. If `DEVELOPER_DIR` is not set, the scripts default to
