...
TestFlight publication. TestFlight mode also expects App Store Connect
credentials through `ASC_APP_ID`, `TESTFLIGHT_GROUP`, `ASC_KEY_ID`,
`ASC_ISSUER_ID`, and either `ASC_PRIVATE_KEY_P8` or `ASC_PRIVATE_KEY_FILE`.
